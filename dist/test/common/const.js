...
exports.TASK_FULL_LIST = [
    ...
    // getHtml
    {
        ...
        subType: rule_1.TaskTypeDomSubType.SUB_TYPE_GET_HTML,
        type: rule_1.TaskType.TYPE_DOM
    },
    // getText
    {
    ...
    // dialog
    {
        ...
        promptText: 'Botphus',
        subType: rule_1.TaskTypeEventSubType.SUB_TYPE_DIALOG,
        ...
        children: [
            {
                ...
                subType: rule_1.TaskTypeEventSubType.SUB_TYPE_RESPONSE,
                type: rule_1.TaskType.TYPE_EVENT
            }
        ],
        subType: rule_1.TaskTypeEventSubType.SUB_TYPE_REQUEST,
        type: rule_1.TaskType.TYPE_EVENT
    },
    // jsonp response
    {
    ...
    // deleteCookie
    {
        ...
        subType: rule_1.TaskTypePageSubType.SUB_TYPE_DELETE_COOKIE,
        type: rule_1.TaskType.TYPE_PAGE
    },
    // getCookie
    {
...
exports.TASK_UNION_NON_BLOCK_LIST = [
    {
        ...
        subType: rule_1.TaskTypeUnionSubType.SUB_TYPE_NON_BLOCK,
        type: rule_1.TaskType.TYPE_UNION
    }
];
function countListCase(list) {
    ...
    list.forEach((rule) => {
        totalCount++;
        if (rule.type === rule_1.TaskType.TYPE_EVENT || rule.type === rule_1.TaskType.TYPE_UNION) {
...
exports.TASK_UNION_NON_BLOCK_CASE_COUNT = countListCase(exports.TASK_UNION_NON_BLOCK_LIST);
